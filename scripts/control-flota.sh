...
case "$accion" in
  ...
  errores)
    ...
    ;;
  *)
    echo "Acción no permitida. Usa: estado, agentes, siguiente, issue N, aprobar PR, aprobar-todo, confirmar CÓDIGO, rechazar PR, detener, reanudar, errores [N] o ayuda." >&2
    exit 64
    ;;
esac
